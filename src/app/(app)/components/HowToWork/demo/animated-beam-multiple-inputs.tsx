...
import { AnimatedBeam } from "@src/components/ui/animatedBeam";
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 w-12 h-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
...
export default function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex size-full w-full h-full max-w-lg flex-row items-stretch justify-between gap-10">
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref}>
            <BookmarkIcon className="w-12 h-12"></BookmarkIcon>
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16 h-16 w-16">
            <Icons.openai />
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref} className="bg-[azure]">
            {/* <Icons.googleDrive /> */}
            <Tag  />
          </Circle>
          <Circle ref={div2Ref} className="bg-[beige]">
            {/* <Icons.googleDocs /> */}
            <Tag  />
          </Circle>
          <Circle ref={div3Ref} className="bg-[aqua]">
            {/* <Icons.whatsapp /> */}
            <Tag />
          </Circle>
          <Circle ref={div4Ref} className="bg-[cadetblue]">
            {/* <Icons.messenger /> */}
            <Tag />
          </Circle>
          <Circle ref={div5Ref}>
